          ...
          <table className="w-full border-collapse border border-gray-500">
            <thead>
              <tr className="bg-gray-300 text-gray-800 text-left">
                ...
                <th className="py-3 px-5 border border-gray-500">CreatedBy</th>
                <th className="py-3 px-8 border border-gray-500">
                  AssignTo
                </th>{" "}
                <th className="py-3 px-9 border border-gray-500">Status</th>{" "}
                <th className="py-3 px-3 border border-gray-500">Reminder</th>
                ...
                userdata.map((item, index) => {
                  ...
                  return (
                    <tr key={item.id}>
                      ...
                      <td className="py-3 px-1 font-semibold w-1/7">{item.email}</td>
